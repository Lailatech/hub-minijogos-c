        ...
        if (menu == 1) {
            ...
            case 1:
                do {
                    ...
                    printf("PERGUNTAS E RESPOSTAS\n");
                    printf ("Segunda Pergunta :Qual foi o primeiro filme da historia a ter som sincronizado com as imagens? \n");
                    ...
                    printf("PERGUNTAS E RESPOSTAS\n");
                    printf("Terceira Pergunta: Qual desses filmes ganhou mais oscars na historia do cinema? (empatado no recorde)\n");
                    printf("1) Titanic\n");
                    printf("2) Avatar\n");
